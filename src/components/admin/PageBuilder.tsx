...
import {
  ...
  ArrowUp, ArrowDown, Code, Link2, Box, Sparkles, ChevronDown,
} from "lucide-react";
...
const BLOCK_CATALOG: { type: BlockType; label: string; icon: React.ReactNode; desc: string }[] = [
  { type: "hero", label: "Hero Section", icon: <Sparkles className="w-4 h-4" />, desc: "Full-width hero with title, subtitle, CTA" },
